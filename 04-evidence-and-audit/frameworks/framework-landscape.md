...
| **NIST 800-53** | The catalog underneath FedRAMP baselines and a named JD requirement. My engine renders an 800-53 profile from the same control set that renders everything else | [Engine bridge](../../generated/engine-bridge.md); becomes primary the moment the FedRAMP strategy question gets a real answer |
