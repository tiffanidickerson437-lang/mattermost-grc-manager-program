...
Usage:
    python3 04-evidence-and-audit/data/brilliant_basics.py            # report to stdout
    python3 04-evidence-and-audit/data/brilliant_basics.py --render   # write the .md
"""
...
def render(rows, s, titles):
    ...
    A("> Generated by `04-evidence-and-audit/data/brilliant_basics.py` from")
