...
| 05 | The questionnaire answer bank has a defect | live page | **[Shipped: the linter](../deliverables/questionnaire-linter/)** |
| 06 | `llms.txt` publishes two conflicting trees | llms.txt | [Split-tree fix](../deliverables/README.md#5-llmstxt-split-tree-fix) |
...
Questions CISOs Must Answer"* on the Mattermost blog — AI risk-assessment guidance for
...
Nick Misasi's *"Multiplayer Tool Calling for Secure Operations"* (17 Jun 2026) is the most
...
→ **[The linter](../deliverables/questionnaire-linter/)** — runs against their live page in
...
`handbook.mattermost.com/llms.txt` is real, served as `text/markdown`, and every page is
