...
|---|---|---|---|
| Days 1 to 30 | [`phase-1-discover.md`](phase-1-discover.md) | Discover and verify | Current-state map, recalibrated 90-day contract with my manager, first visible fixes |
| Days 31 to 60 | [`phase-2-design.md`](phase-2-design.md) | Execute the assessment, pilot the automation | CMMC L2 self-assessment executed on the agreed boundary; continuous-monitoring pilot live on one control family |
| Days 61 to 90 | [`phase-3-operate.md`](phase-3-operate.md) | Deliver and institutionalize | Metric 1 delivered; pilot extended; team proposal; 90-day report |
...
- The plan assumes answers to the first four [hiring manager questions](../00-governance/open-questions.md) arrive before or during week one. Where an answer would change the plan, the phase files say so at that step.
