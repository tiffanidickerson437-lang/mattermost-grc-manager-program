...
Full procedure in the [runbook](../runbooks/cmmc-l2-self-assessment.md). The shape of it:
...
Full procedure in the [runbook](../runbooks/continuous-controls-pilot.md). Design constraints:
...
The Drata question from the [hiring manager questions](../hiring-manager-questions.md) answered as a formal decision brief, informed by 30 days of living in the real stack:
