...
what was compared, against which upstream version, and when.
    ...
    committed  06-evidence-and-audit/data/fedramp-20x-ksi-mapping.yaml
    receipt    06-evidence-and-audit/upstream-conformance-receipt.md
...
the entire reason this program exists, so this file does not get to commit it.
    ...
    python3 06-evidence-and-audit/data/upstream_drift.py            # reconcile, write receipt
    python3 06-evidence-and-audit/data/upstream_drift.py --check    # CI: no write, exit code only
...
def render_receipt(findings: list[str], f: dict) -> str:
    ...
    L = [
        ...
        "",
        "Machine-generated by [`06-evidence-and-audit/data/upstream_drift.py`](data/upstream_drift.py).",
