...
Usage:
    python3 assessment/data/brilliant_basics.py            # report to stdout
    python3 assessment/data/brilliant_basics.py --render   # write the .md
"""
...
OUT = REPO / "assessment" / "brilliant-basics-map.md"
...
def render(rows, s, titles):
    ...
    A("> Generated by `assessment/data/brilliant_basics.py` from")
    ...
    for b in s["blind_spots"]:
        ...
        A("It also lands exactly on [finding 03](../findings/#03--no-internal-ai-policy-while-publishing-ai-risk-guidance-for-other-people):")
