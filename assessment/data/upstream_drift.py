...
what was compared, against which upstream version, and when.
    ...
    committed  assessment/data/fedramp-20x-ksi-mapping.yaml
    receipt    assessment/upstream-conformance-receipt.md
...
the entire reason this program exists, so this file does not get to commit it.
    ...
    python3 assessment/data/upstream_drift.py            # reconcile, write receipt
    python3 assessment/data/upstream_drift.py --check    # CI: no write, exit code only
