...
affirmation is the single worst place to make it.
    ...
    python3 assessment/data/affirmation_gate.py --state <file>
    python3 assessment/data/affirmation_gate.py --state <file> --check
"""
...
def render(blockers: list[str], f: dict, state: dict, rule_date: str) -> str:
    ...
    L = [
        ...
        "",
        "Machine-generated by [`assessment/data/affirmation_gate.py`](data/affirmation_gate.py). "
