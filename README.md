...
```bash
pip install pyyaml
python3 06-evidence-and-audit/questionnaire-linter/lint_answers.py     # runs against the live page
```
...
python3 06-evidence-and-audit/questionnaire-linter/lint_answers.py     # the live answer bank
